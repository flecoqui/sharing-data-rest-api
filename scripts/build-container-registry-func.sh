...
cp ./src/registry_rest_api/src/shared_code/app.py ./src/registry_rest_api/func/shared_code/app.py
cp ./src/registry_rest_api/src/shared_code/configuration_service.py ./src/registry_rest_api/func/shared_code/configuration_service.py
cp ./src/registry_rest_api/src/shared_code/log_service.py ./src/registry_rest_api/func/shared_code/log_service.py
cp ./src/registry_rest_api/src/shared_code/models.py ./src/registry_rest_api/func/shared_code/models.py
cp ./src/registry_rest_api/src/shared_code/registry_service.py ./src/registry_rest_api/func/shared_code/registry_service.py
buildWebAppContainer "${ACR_LOGIN_SERVER}" "./src/registry_rest_api/func" "registry_rest_api_func" "${APP_VERSION}" "latest" ${APP_PORT}
checkError
