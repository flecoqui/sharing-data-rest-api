...
# Build share-api docker image
#force http port to 80
APP_PORT=80
printMessage "Building share_rest_api container version:${APP_VERSION} port: ${APP_PORT}"
cp ./src/share_rest_api/src/shared_code/app.py ./src/share_rest_api/func/shared_code/app.py
cp ./src/share_rest_api/src/shared_code/configuration_service.py ./src/share_rest_api/func/shared_code/configuration_service.py
cp ./src/share_rest_api/src/shared_code/log_service.py ./src/share_rest_api/func/shared_code/log_service.py
cp ./src/share_rest_api/src/shared_code/models.py ./src/share_rest_api/func/shared_code/models.py
cp ./src/share_rest_api/src/shared_code/share_service.py ./src/share_rest_api/func/shared_code/share_service.py
cp ./src/share_rest_api/src/shared_code/datashare_service.py ./src/share_rest_api/func/shared_code/datashare_service.py
buildWebAppContainer "${ACR_LOGIN_SERVER}" "./src/share_rest_api/func" "share_rest_api_func" "${APP_VERSION}" "latest" ${APP_PORT}
checkError
