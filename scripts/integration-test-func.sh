...
"$SCRIPTS_DIRECTORY"/deploy-registry-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.registry.env
printMessage "Deploy Share node 1 infrastructure"
"$SCRIPTS_DIRECTORY"/deploy-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.sharea.env
printMessage "Deploy Share node 2 infrastructure"
"$SCRIPTS_DIRECTORY"/deploy-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.shareb.env

printMessage "Build and Deploy Registry REST API"
"$SCRIPTS_DIRECTORY"/build-container-registry-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.registry.env
"$SCRIPTS_DIRECTORY"/deploy-container-registry-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.registry.env
...
"$SCRIPTS_DIRECTORY"/build-container-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.sharea.env
"$SCRIPTS_DIRECTORY"/deploy-container-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.sharea.env "https://${REGISTRY_APP_SERVER}"

printMessage "Build and Deploy share REST API"
"$SCRIPTS_DIRECTORY"/build-container-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.shareb.env
"$SCRIPTS_DIRECTORY"/deploy-container-share-func.sh  "$SCRIPTS_DIRECTORY"/../configuration/.shareb.env  "https://${REGISTRY_APP_SERVER}"
